...
export const compressFile = async (currentPath, [pathToFile, pathToDestinationFile]) => {
...
export const decompressFile = async (currentPath, [pathToFile, pathToDestinationFile]) => {
    const pathForRead = pathResolver(currentPath, [pathToFile]);
...
//# sourceMappingURL=brothli.js.map